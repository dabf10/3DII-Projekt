...
private:
    ...
    CComPtr<ID3D11ShaderResourceView> m_ptex2DEpipolarSampleWorldPosSRV;
    CComPtr<ID3D11RenderTargetView> m_ptex2DEpipolarSampleWorldPosRTV;
    ...
    CComPtr<ID3D11ShaderResourceView> m_ptex2DSliceUVDirInShadowMapSRV;
    CComPtr<ID3D11RenderTargetView> m_ptex2DSliceUVDirInShadowMapRTV;
